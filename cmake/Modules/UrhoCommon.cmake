...
if (ARM AND (APPLE OR URHO3D_64BIT OR "${ARM_ABI_FLAGS}" MATCHES neon))    # Stringify in case ARM_ABI_FLAGS is not set explicitly
...
if (CMAKE_PROJECT_NAME STREQUAL Urho3D)
    ...
    cmake_dependent_option (URHO3D_TOOLS "Build tools (native and ARM on Linux only)" TRUE "NOT IOS AND NOT TVOS AND NOT ANDROID AND NOT WEB" FALSE)
    cmake_dependent_option (URHO3D_EXTRAS "Build extras (native and ARM on Linux only)" FALSE "NOT IOS AND NOT TVOS AND NOT ANDROID AND NOT WEB" FALSE)
    ...
    if (((URHO3D_LUA AND NOT URHO3D_LUAJIT)) AND NOT ANDROID AND NOT IOS AND NOT TVOS AND NOT WEB AND NOT WIN32)
    ...
    if (URHO3D_PCH OR URHO3D_SAMPLES OR URHO3D_TOOLS OR URHO3D_EXTRAS)
